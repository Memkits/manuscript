      ...
      :defs $ {}
                      ...
                      .sort-by $ fn (draft)
                        let
                          ...
                          negate $ if
                            ...
                            , js/Number.MAX_VALUE $ unsafe-coerce (&map:get draft-map :touch-id) 'Number
        ...
        'style-textbox $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defstyle style-textbox
            {} $ |& $ {} (:border :none) (:line-height |1.6em) (:font-size 16) (:outline :none)
      ...
      :defs $ {}
        ...
        'draft $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def draft
            {} (:id nil) (:text |) (:touch-id nil) (:mono? false)
          :examples $ []
          :schema $ :: 'Dynamic
        'store $ %{} 'CodeEntry (:doc |)
